...
<meta name="description" content="Landing SSO Universitas Jember by Techies" />
<!-- SITE TITLE -->
<title>Connected &RightTriangleBar; Internet Cepat Universitas Jember</title>
<!-- Favicon Icon -->
<link rel="shortcut icon" type="image/x-icon" href="http://uptti.unej.ac.id/wp-content/uploads/2017/11/new-logo.png">
...
<section id="home" class="section_gradiant">
    ...
    <div class="row align-items-center">
      <div class="col-lg-6 col-md-12 col-sm-12 order-lg-first text_md_center">
        <div class="banner_text">
          <h1>Anda Telah Terhubung Dengan<span> Internet Cepat</span></h1>
          <h3 style="color:#f6ed58;">UNIVERSITAS JEMBER</h3>
	  <p>
	  <p><span>Gunakanlah secara bijak sesuai norma dan peraturan perundang-undangan yang berlaku.</span></p><br/><h6 style="font-size=10;">&copy; UPT. Teknologi Informasi dan Komunikasi</h6>
          <!-- <div class="banner_btn"> <a href="#whitepaper" class="btn btn-default page-scroll nav-link">Whitepapter <i class="ion-ios-arrow-thin-right"></i></a> <a href="#" class="btn btn-border">Buy Token Now! <i class="ion-ios-arrow-thin-right"></i></a> </div> -->
        </div>
      </div>
      <div class="col-lg-6 col-md-12 col-sm-12 order-first">
        <div class="banner_image_right res_md_mb_50 res_xs_mb_30"> 
        	<img src="https://unej.ac.id/wp-content/uploads/2020/10/banner_vector31.png" alt="banner_vector"/> 
        </div>
        </div>
    </div>
  </div>
    ...
    <div class="row align-items-center">
      <div class="col-lg-5 col-md-12 col-sm-12">
        <div class="title_dark">
          <h2>Informasi</h2>
          <p>Bagi civitas akademik Universitas Jember yang belum dapat mengakses <b>SIKD</b> dan <b>UC3</b>,</p>
        </div>
        <a href="#" class="btn btn-default page-scroll">ikuti langkah berikut <i class="ion-ios-arrow-thin-right"></i></a> </div>
      <div class="col-lg-7 col-md-12 col-sm-12">
        <div class="work_box">
          <div class="box_inner"> <i class="ion-social-chrome"></i>
            <h4>Clear Cache Browser</h4>
            <p>Tekan tombol <mark>CTRL+SHIFT+DEL</mark> bersamaan pada browser -><br/><br/> Pilih durasi penghapusan cache -><br/><br/> Centang semua elemen yang akan dihapus -><br/><br/> Klik Clear Data.</p>
          </div>
        </div>
        <div class="work_box">
          <div class="box_inner"> <i class="ion-ios-locked"></i>
            <h4>Flush DNS</h4>
            <p>Tekan tombol <mark>Windows+R</mark> -><br/><br/>Kemudian ketik <mark>cmd</mark> pada kolom Run -><br/><br/>Setelah Comand Promt terbuka, ketik perintah berikut <mark>ipconfig /flushdns</mark> -> <br/><br/>Tunggu hingga proses selesai.</p>
          </div>
        </div>
        <div class="work_box">
          <div class="box_inner"> <i class="ion-refresh"></i>
            <h4>Restart Komputer</h4>
            <p>Langkah terakhir adalah melakukan restart pada komputer Anda. </p>
          </div>
        </div>
      </div> 
    </div>
    ...
    <div class="row align-items-center">
      ...
      <div class="col-lg-6 col-md-6 col-sm-12">
        <div class="title_light"> 
          <span>What is Cryptoking</span>
          <h2>About The Cryptoking</h2>
    ...
    <div id="mobileapp" class="mobileapp text_md_center">
        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-sm-12">
                <div class="title_light">
                    <span>CryptoKing App</span>
                    <h2>Download Mobile App</h2>
                    <p>The Cryptoking very own app is available to download for your iPhone or Android&trade; device! ... Now Download the new mobile app, and get the most out of your membership with special tools designed to enhance your experience.</p>
                    <p>Download the Cryptoking new mobile app, and get the most out of your membership with special tools designed to enhance your 
    experience.</p>
                </div>
                <div>
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 res_md_mb_30">
        <div class="team_box">
          ...
          <div id="team1" class="team_pop mfp-hide">
            <div class="row m-0">
              <div class="col-md-6"> <img class="w-100 pt-3 pb-3" src="assets/images/team-lg-1.jpg" alt="team1"/> </div>
              <div class="col-md-6">
                <div class="pt-3 pb-3">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 res_md_mb_30">
        <div class="team_box">
          ...
          <div id="team2" class="team_pop mfp-hide">
            <div class="row m-0">
              <div class="col-md-6"> <img class="w-100 pt-3 pb-3" src="assets/images/team-lg-2.jpg" alt="team2"/> </div>
              <div class="col-md-6">
                <div class="pt-3 pb-3">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6 res_xs_mb_30">
        <div class="team_box">
          ...
          <div id="team3" class="team_pop mfp-hide">
            <div class="row m-0">
              <div class="col-md-6"> <img class="w-100 pt-3 pb-3" src="assets/images/team-lg-3.jpg" alt="team3"/> </div>
              <div class="col-md-6">
                <div class="pt-3 pb-3">
      ...
      <div class="col-lg-3 col-md-6 col-sm-6">
        <div class="team_box">
          ...
          <div id="team4" class="team_pop mfp-hide">
            <div class="row m-0">
              <div class="col-md-6"> <img class="w-100 pt-3 pb-3" src="assets/images/team-lg-4.jpg" alt="team4"/> </div>
              <div class="col-md-6">
                <div class="pt-3 pb-3">
    ...
    <div class="row small_space justify-content-center">
      <div class="col-lg-9 col-md-12">
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 res_md_mb_30">
            <div class="team_box">
              ...
              <div id="team5" class="team_pop mfp-hide">
                <div class="row m-0">
                  <div class="col-md-6"> <img class="w-100 pt-3 pb-3" src="assets/images/team-lg-5.jpg" alt="team5"/> </div>
                  <div class="col-md-6">
                    <div class="pt-3 pb-3">
          ...
          <div class="col-lg-4 col-md-6 col-sm-6 res_md_mb_30">
            <div class="team_box">
              <div class="team_img text-center"> <img src="assets/images/team6.jpg" alt="team6"/>
                <div class="social_team list_none">
                  <ul>
                    <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                    <li><a href="#"><i class="ion-social-twitter"></i></a></li>
              ...
              <div id="team6" class="team_pop mfp-hide">
                <div class="row m-0">
                  <div class="col-md-6"> <img class="w-100 pt-3 pb-3" src="assets/images/team-lg-6.jpg" alt="team6"/> </div>
                  <div class="col-md-6">
                    <div class="pt-3 pb-3">
                      <div class="title_dark"> <span>Invester</span>
                        <h2>Julie Tokar</h2>
          ...
          <div class="col-lg-4 offset-lg-0 col-md-6 offset-md-3 col-sm-6 offset-sm-3">
            <div class="team_box">
              <div class="team_img text-center"> <img src="assets/images/team7.jpg" alt="team7"/>
                <div class="social_team list_none">
                  <ul>
                    <li><a href="#"><i class="ion-social-facebook"></i></a></li>
                    <li><a href="#"><i class="ion-social-twitter"></i></a></li>
              ...
              <div id="team7" class="team_pop mfp-hide">
                <div class="row m-0">
                  <div class="col-md-6"> <img class="w-100 pt-3 pb-3" src="assets/images/team-lg-7.jpg" alt="team7"/> </div>
                  <div class="col-md-6">
                    <div class="pt-3 pb-3">
                      <div class="title_dark"> <span>Invester</span>
                        <h2>Sandhya Rani</h2>
...
<footer>
    ...
    <div class="bottom_footer">
    	<div class="container">
        	<div class="row">
            	<div class="col-md-6">
                	<p class="copyright">Copyright &copy; 2021 Universitas Jember. All Rights Reserved.</p>
                </div>
                <div class="col-md-6">
